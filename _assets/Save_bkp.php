...
/**
* Mind 
* Copyright (C) 2022 Mind  <haroonmind@gmail.com>
*
* NOTICE OF LICENSE
*
...
*
* @category Mind
* @package Mind_ImportCustomer
* @copyright Copyright (c) 2022 Mind
* @license http://opensource.org/licenses/gpl-3.0.html GNU General Public License,version 3 (GPL-3.0)
* @author Mind  <haroonmind@gmail.com>
*/
namespace Mind\Importexportcategory\Controller\Adminhtml\Importcategory;
...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
            ...
            if ($filepath!='' && file_exists($filepath)) {
                ...
                if (isset($data[0]) && !empty($data[0])) {
                                ...
                                if ($cateitem->getId()) {
                                    ...
                                    if ($parentid!=$_parentid && $cateitem->getId()>2) {
                                        ...
                                        if ($parentcat->getId()) {
                                            ...
                                            $resultRedirect->setPath('mind_importexportcategory/*/edit');
                    ...
                    if (isset($alreadyexist) && !empty($alreadyexist)) {
                        ...
                        unlink($filepath);
                        $this->_backendSession->setMindImportcategoryTestData(false);
                        $resultRedirect->setPath('mind_importexportcategory/*/edit');
                        return $resultRedirect;
                } else {
        ...
        $resultRedirect->setPath(
            'mind_importexportcategory/*/edit',
            [
                '_current' => true
            ]
        );
    ...
    protected function _uploadFileAndGetName()
    {
        ...
        ->getAbsolutePath('import_history');
